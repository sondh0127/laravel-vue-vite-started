export const formPreflight = {
    layer: '_forms_css',
    getCSS: ({ theme }: any) => {
        const encodeSvg = (svg: any) => `data:image/svg+xml,${svg
        ...
        const grayDarkMode = theme?.colors?.gray?.[400] ?? '#9ca3af'
        const blue = theme?.colors?.blue?.[600] ?? '#2563eb'
        const blueDarkMode = theme?.colors?.blue?.[300] ?? '#93c5fd'
        ...
        const rules = [
            ...
            },
            {
                ...
                styles: {
                    ...
                    '--un-ring-color': blueDarkMode,
                    'border-color': blueDarkMode,
                },
            },
            {
            ...
            },
            {
                ...
                styles: {
                    'background-image': `url("${encodeSvg(
                        `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20"><path stroke="${gray
            ...
            },
            {
                ...
                styles: {
                    'background-image': `url("${encodeSvg(
                        `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20"><path stroke="${grayDarkMode
                        }" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M6 8l4 4 4-4"/></svg>`,
                    )}")`,
                },
            },
